...
import 'package:tubes_skype/configs/agora_configs.dart';
...
class _CallScreenState extends State<CallScreen> {
  ...
  '''{\"che.video.lowBitRateStreamParameter\":{\"width\":320,\"height\":180,
  \"frameRate\":15,\"bitRate\":140}}''');
  ...
  addPostFrameCallback(){
    SchedulerBinding.instance.addPostFrameCallback((_) {
      ...
      callStreamSubscription = callMethods
          .callStream(uid: userProvider.getUsersData.uid)
